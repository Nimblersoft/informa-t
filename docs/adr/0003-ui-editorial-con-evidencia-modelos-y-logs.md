...
La consecuencia es que el HTML exploratorio sirve como referencia visual, no como fuente de datos ni contrato de comportamiento. Su lista de cuatro veredictos, sus porcentajes y sus mocks monolíticos deben sustituirse durante la implementación por los contratos vigentes del PRD.
